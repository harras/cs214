//mymalloc.c: framework to simulate memory allocation and allow for improved malloc and free functions


//block headers are 4 byte linked lists with a 2 byte "next" pointer (an offset from front of the block) and 2 byte memory size field
//block structure:
//       [][]                         [][]                            [][][]][][][][].....
